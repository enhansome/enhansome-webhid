...
* Neither the WebUSB<sup>[(ref)](https://github.com/WICG/webusb/issues/29) ⭐ 1,409 | 🐛 45 | 🌐 Bikeshed | 📅 2026-06-05</sup> or Web Bluetooth<sup>[(ref)](https://github.com/WebBluetoothCG/web-bluetooth/issues/393) ⭐ 1,448 | 🐛 106 | 🌐 Bikeshed | 📅 2026-06-03</sup> APIs allow access to HID-class devices.
...
* [chrome.hid API sample](https://github.com/GoogleChrome/chrome-app-samples/tree/master/samples/hid) ⭐ 17,770 | 🐛 54 | 🌐 JavaScript | 📅 2026-09-18 - Generic input/output Chrome App sample.
* [blink(1) using the chrome.hid API](https://github.com/GoogleChrome/chrome-app-samples/tree/master/samples/blink1) ⭐ 17,770 | 🐛 54 | 🌐 JavaScript | 📅 2026-09-18 - Chrome App sample that controls a [Blink(1)](https://blink1.thingm.com) notification LED.
