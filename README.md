...
* Neither the WebUSB<sup>[(ref)](https://github.com/WICG/webusb/issues/29) ⭐ 1,408 | 🐛 44 | 🌐 Bikeshed | 📅 2026-06-05</sup> or Web Bluetooth<sup>[(ref)](https://github.com/WebBluetoothCG/web-bluetooth/issues/393) ⭐ 1,448 | 🐛 102 | 🌐 Bikeshed | 📅 2026-06-03</sup> APIs allow access to HID-class devices.
