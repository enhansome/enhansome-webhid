...
* [@elgato-stream-deck/webhid](https://github.com/julusian/node-elgato-stream-deck) ⭐ 204 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-16 - using the Elgato Stream Deck (see demos).
...
* [Elgato StreamDeck](https://julusian.github.io/node-elgato-stream-deck/) - using the Elgato Stream Deck (via [@elgato-stream-deck/webhid](https://github.com/julusian/node-elgato-stream-deck) ⭐ 204 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-16).
...
* [chrome.hid API sample](https://github.com/GoogleChrome/chrome-app-samples/tree/master/samples/hid) ⭐ 17,770 | 🐛 54 | 🌐 JavaScript | 📅 2026-09-15 - Generic input/output Chrome App sample.
* [blink(1) using the chrome.hid API](https://github.com/GoogleChrome/chrome-app-samples/tree/master/samples/blink1) ⭐ 17,770 | 🐛 54 | 🌐 JavaScript | 📅 2026-09-15 - Chrome App sample that controls a [Blink(1)](https://blink1.thingm.com) notification LED.
