...
* [node-hid](https://github.com/node-hid/node-hid) ⭐ 1,579 | 🐛 46 | 🌐 C++ | 📅 2026-07-20 - Cross-platform library for accessing USB HID devices from Node.js or Electron.
...
* [chrome.hid API sample](https://github.com/GoogleChrome/chrome-app-samples/tree/master/samples/hid) ⭐ 17,775 | 🐛 54 | 🌐 JavaScript | 📅 2026-09-18 - Generic input/output Chrome App sample.
* [blink(1) using the chrome.hid API](https://github.com/GoogleChrome/chrome-app-samples/tree/master/samples/blink1) ⭐ 17,775 | 🐛 54 | 🌐 JavaScript | 📅 2026-09-18 - Chrome App sample that controls a [Blink(1)](https://blink1.thingm.com) notification LED.
